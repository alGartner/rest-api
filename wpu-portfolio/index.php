...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#home">Alvino Gartner</a>
    ...
    <div class="jumbotron" id="home">
      <div class="container">
        <div class="text-center">
          ...
          <h1 class="display-4">Alvino Gartner</h1>
            ...
            <div class="row mt-3 pb-3">
              <div class="col">
                <div class="embed-responsive embed-responsive-16by9">
                  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/vnb7tDfB4dk?rel=0" allowfullscreen></iframe>
                  </div>
                </div>
              </div>
              ...
              <div class="row mt-3 pb-3">
                <div class="col">
                  <div class='ig-thumbnail'>
                    <img class="" src="img/thumbs/1.png" alt="">
                  </div>
                  <div class='ig-thumbnail'>
                    <img class="" src="img/thumbs/1.png" alt="">
                  </div>
